            ...
            if ret:
                ...
                if self.init_num < 20:
                    if self.get_calculate_params(frame) is None:
                        print('self.get_calculate_params(frame) is None')
                        show = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
                        showImage = QImage(show.data, show.shape[1], show.shape[0], show.shape[1] * 3,
                                                    QImage.Format_RGB888)
                        ...
                        print('self.get_calculate_params(frame) not None')
                ...
                if self.nparams < 10:
                    if self.get_calculate_params(frame) is None:
                        print('self.nparams --- self.get_calculate_params(frame) is None')
                        ...
                        print('self.nparams --- self.get_calculate_params(frame) not None')
